...
<head>
  ...
  <!-- laravel CRUD token -->
  <meta name="csrf-token" content="8eqPdiKb15klvbpRr8ZITLIKswffyNxDPGmxDkGF">
  <!-- Canonical SEO -->
...
<!-- Vendor Styles -->
<link rel="stylesheet" href="../../demo/assets/vendor/libs/fullcalendar/fullcalendar.css" />
<link rel="stylesheet" href="../../demo/assets/vendor/libs/flatpickr/flatpickr.css" />
<link rel="stylesheet" href="../../demo/assets/vendor/libs/select2/select2.css" />
<link rel="stylesheet" href="../../demo/assets/vendor/libs/quill/editor.css" />
<link rel="stylesheet" href="../../demo/assets/vendor/libs/formvalidation/dist/css/formValidation.min.css" />


<!-- Page Styles -->
<link rel="stylesheet" href="../../demo/assets/vendor/css/pages/app-calendar.css" />
      ...
      pathResolver: function(path) {
        var resolvedPaths = {
          ...
          // Themes
            ...
            'https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/vendor/css/rtl/theme-default-dark.css?id=9a338740c08a948bb83b45bbd12fb4aa',
            ...
            'https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/vendor/css/rtl/theme-bordered-dark.css?id=18f699a37ba20ce77d7e28d9cb364a77',
            ...
            'https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/vendor/css/rtl/theme-semi-dark-dark.css?id=0c263a3742f3ca2d2cb3e92439d5f540',
                  }
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item ">
      <a href="javascript:void(0);" class="menu-link menu-toggle" >
                ...
                <div>Cadastro de Atendentes</div>
      </a>
    ...
    <li class="menu-item ">
      <a href="javascript:void(0);" class="menu-link menu-toggle" >
                ...
                <div>Demonstrativo de Resultados do Exercicio</div>
      </a>
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          ...
          <li class="nav-item dropdown-language dropdown me-2 me-xl-0">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li>
                <a class="dropdown-item" href="calendar.html" data-language="en">
                  <i class="fi fi-us fis rounded-circle fs-4 me-1"></i>
                  <span class="align-middle">Atentente1</span>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="calendar.html" data-language="fr">
                  <i class="fi fi-fr fis rounded-circle fs-4 me-1"></i>
                  <span class="align-middle">Atentente2</span>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="calendar.html" data-language="de">
                  <i class="fi fi-de fis rounded-circle fs-4 me-1"></i>
                  <span class="align-middle">Atendente3</span>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="calendar.html" data-language="pt">
                  <i class="fi fi-pt fis rounded-circle fs-4 me-1"></i>
                  <span class="align-middle">Atendente4</span>
                </a>
              </li>
            </ul>
          </li>
      ...
      <div class="border-bottom p-4 my-sm-0 mb-3">
        <div class="d-grid">
          <button class="btn btn-primary btn-toggle-sidebar" data-bs-toggle="offcanvas" data-bs-target="#addEventSidebar" aria-controls="addEventSidebar">
            ...
            <span class="align-middle">Agendar horario</span>
          </button>
        </div>
      </div>
      <div class="p-4">
        ...
        <!-- Filter -->
        <div class="mb-4">
          <small class="text-small text-muted text-uppercase align-middle">Atendentes</small>
        </div>

        <div class="form-check mb-2">
          <input class="form-check-input select-all" type="checkbox" id="selectAll" data-value="all" checked>
          <label class="form-check-label" for="selectAll">Ver todos(a)</label>
        </div>

        <div class="app-calendar-events-filter">
          <div class="form-check form-check-danger mb-2">
            <input class="form-check-input input-filter" type="checkbox" id="select-personal" data-value="personal" checked>
            <label class="form-check-label" for="select-personal">Atendente1</label>
          </div>
          <div class="form-check mb-2">
            <input class="form-check-input input-filter" type="checkbox" id="select-business" data-value="business" checked>
            <label class="form-check-label" for="select-business">Atendente2</label>
          </div>
          <div class="form-check form-check-warning mb-2">
            <input class="form-check-input input-filter" type="checkbox" id="select-family" data-value="family" checked>
            <label class="form-check-label" for="select-family">atendente3</label>
          </div>
          <div class="form-check form-check-success mb-2">
            <input class="form-check-input input-filter" type="checkbox" id="select-holiday" data-value="holiday" checked>
            <label class="form-check-label" for="select-holiday">Atendente4</label>
          </div>
          <div class="form-check form-check-info">
            <input class="form-check-input input-filter" type="checkbox" id="select-etc" data-value="etc" checked>
            <label class="form-check-label" for="select-etc">Atendente5</label>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col app-calendar-content">
      ...
      <div class="offcanvas offcanvas-end event-sidebar" tabindex="-1" id="addEventSidebar" aria-labelledby="addEventSidebarLabel">
        <div class="offcanvas-header border-bottom">
          <h5 class="offcanvas-title mb-2" id="addEventSidebarLabel">Serviço</h5>
        ...
        <div class="offcanvas-body">
          <form class="event-form pt-0" id="eventForm" onsubmit="return false">
            ...
            <div class="mb-3">
              <label class="form-label" for="eventLabel">Atentende</label>
              <select class="select2 select-event-label form-select" id="eventLabel" name="eventLabel">
                <option data-label="primary" value="Business" selected>Atendente1</option>
                <option data-label="danger" value="Personal">Atendente2</option>
                <option data-label="warning" value="Family">Atendente3</option>
                <option data-label="success" value="Holiday">Atendente4</option>
                <option data-label="info" value="ETC">Atendente4</option>
              </select>
            </div>
            <div class="mb-3">
              <label class="form-label" for="eventStartDate">Inicio</label>
              <input type="text" class="form-control" id="eventStartDate" name="eventStartDate" placeholder="Start Date" />
            </div>
            <div class="mb-3">
              <label class="form-label" for="eventEndDate">Previsão de encerramento </label>
            ...
            <div class="mb-3">
              ...
              <input type="url" class="form-control" id="eventURL" name="eventURL" placeholder="#" />
            </div>
            <div class="mb-3 select2-primary">
              <label class="form-label" for="eventGuests">Auxiliar</label>
            ...
            <div class="mb-3">
              <label class="form-label" for="eventLocation">Produto</label>
              <input type="text" class="form-control" id="eventLocation" name="eventLocation" placeholder="Enter Location" />
            </div>
            <div class="mb-3">
              <label class="form-label" for="eventDescription">Descrição detalhada</label>
              <textarea class="form-control" name="eventDescription" id="eventDescription"></textarea>
            </div>
            <div class="mb-3 d-flex justify-content-sm-between justify-content-start my-4">
              <div>
                <button type="submit" class="btn btn-primary btn-add-event me-sm-3 me-1">agendar</button>
...
<script src="../../demo/assets/vendor/libs/fullcalendar/fullcalendar.js"></script>
...
<script src="../../demo/assets/vendor/libs/flatpickr/flatpickr.js"></script>
...
<!-- BEGIN: Page JS-->
<script src="../../demo/assets/js/app-calendar-events.js"></script>
<script src="../../demo/assets/js/app-calendar.js"></script>
<!-- END: Page JS-->

</body>


<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo-1/app/calendar by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Feb 2023 22:29:58 GMT -->
</html>
