    ...
    return (function () {
        ...
        return (
            (function () {
                ...
                function c(t, e, s) {
                    return (e = d(e)) in t ? Object.defineProperty(t, e, { value: s, enumerable: !0, configurable: !0, writable: !0 }) : (t[e] = s), t;
                }
                function u(t, e) {
                ...
                var h = ["rtl", "style", "layoutType", "layoutMenuFlipped", "showDropdownOnHover", "layoutNavbarFixed", "layoutFooterFixed", "themes"],
                    m = ["light", "dark"],
                    p = document.documentElement.classList,
                    y = document.getElementsByTagName("HTML")[0].getAttribute("data-theme") || 0,
                    f = p.contains("dark-style") ? "dark" : "light",
                    g = "rtl" === document.documentElement.getAttribute("dir"),
                    v = !!p.contains("layout-menu-collapsed"),
                    b = !!p.contains("layout-menu-flipped"),
                    _ = !!p.contains("layout-navbar-fixed"),
                    x = !!p.contains("layout-footer-fixed"),
                    w = p.contains("layout-menu-offcanvas") ? "static-offcanvas" : p.contains("layout-menu-fixed") ? "fixed" : p.contains("layout-menu-fixed-offcanvas") ? "fixed-offcanvas" : "static",
                    S = (function () {
                        function t(e) {
                            var s = e.cssPath,
                                i = e.themesPath,
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    (this.settings.defaultNavbarFixed = void 0 !== p ? p : _),
                                    ...
                                    value: function (t) {
                                        ...
                                        if (this._hasControls("themes")) {
                                            ...
                                            if (i) {
                                                ...
                                                this._loadStylesheets(c({}, o, document.querySelector(".template-customizer-theme-css")), s || function () {}), e && this.settings.onSettingsChange.call(this, this.settings);
                                            }
                                        }
                                    },
                                },
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        (t = "" !== r && -1 !== ["static", "static-offcanvas", "fixed", "fixed-offcanvas"].indexOf(r) ? r : this.settings.defaultLayoutType),
                                            ...
                                            this._hasControls("style") || (this.settings.style = p.contains("dark-style") ? "dark" : "light"),
