...
isRtl && (direction = "rtl"), document.addEventListener("DOMContentLoaded", (function () {
    ! function () {
        ...
        function M() {
            ...
            e.setAttribute("data-bs-toggle", "sidebar"), e.setAttribute("data-overlay", ""), e.setAttribute("data-target", "#app-calendar-sidebar"), e.insertAdjacentHTML("beforeend", '')
        }
        L && (k = L.flatpickr({
        ...
        let T = new Calendar(e, {
            ...
            events: function (e, t) {
                let n = function () {
                    let e = [];
                    return [].slice.call(document.querySelectorAll(".input-filter:checked")).forEach((t => {
            ...
            headerToolbar: {
                ...
                end: "timeGridDay,timeGridWeek,listMonth"
            },
            direction: direction,
        ...
        d.addEventListener("click", (e => {
            ...
            var t;
            t = parseInt(E.id), w = w.filter((function (e) {
                return e.id != t
            })), T.refetchEvents(), q.hide()
